...
ko_data = {
    ...
    "menu": {
        ...
        "process": {
            "title": "처리",
            "auto_detect": "자동 얼굴 감지",
            "apply_mosaic": "모자이크 적용",
            "apply_blur": "블러 적용",
            "clear_regions": "영역 초기화"
        },
        "settings": {
            "title": "설정",
            "preferences": "환경 설정"
    ...
    "settings": {
        ...
        "blur_size": "블러 커널 크기",
        "min_neighbors": "최소 이웃 (민감도)",
        "scale_factor": "스케일 팩터 (정밀도)",
        "iou_threshold": "NMS 임계값 (중복제거)",
        "hint_neighbors": "높음 = 오탐지 감소, 낮음 = 검출량 증가",
        "hint_scale": "낮음 = 정밀/느림, 높음 = 빠름",
        "hint_iou": "중복 박스 병합 기준 (IOU)"
    },
    "toolbar": {
        "open": "파일 열기",
        "save": "저장",
    ...
    "mode_desc": {
        "auto": "자동으로 감지된 얼굴에만 효과를 적용합니다.",
        "manual": "사용자가 지정한 수동 영역에만 효과를 적용합니다.",
        "override": "수동 영역이 있으면 우선 적용하고, 없으면 자동 감지를 사용합니다.",
        "append": "자동 감지된 얼굴과 수동 영역 모두에 효과를 적용합니다."
    },
    "status": {
        "ready": "준비",
        "loading": "로딩 중...",
        ...
        "complete": "완료",
        "error": "오류",
        "images_loaded": "이미지 {count}장 로드됨",
        "faces_detected": "얼굴 {count}개 감지됨"
    },
    "dialog": {
        "confirm": "확인",
        "cancel": "취소",
        ...
        "yes": "예",
        "no": "아니오",
        "save_changes": "종료 전에 변경 사항을 저장하시겠습니까?",
        "unsaved_changes": "저장되지 않은 변경 사항이 있습니다.",
        "save_success": "저장되었습니다.",
        "confirm_remove": "선택한 이미지 {count}장을 삭제하시겠습니까?"
    },
    "inspector": {
        "title": "인스펙터",
        "no_selection": "선택 없음",
    ...
    "empty": {
        "title": "로드된 이미지 없음",
        "subtitle": "이미지 또는 폴더를 여기에 드래그하세요",
        "or": "또는",
        "browse": "파일 찾아보기"
    },
    "viewer": {
